window.addEventListener('load', () => {
  ...
  class Player {
    ...
    restart () {
      this.collisionX = this.game.width * 0.5;
      this.collisionY = this.game.height * 0.5;
      this.spriteX = this.collisionY - this.height * 0.5;
    ...
    draw(context) {
      ...
      if (this.game.debug) {
        ...
        context.stroke();
        context.beginPath();
        context.moveTo(this.collisionX, this.collisionY); // starting point
        context.lineTo(this.game.mouse.x, this.game.mouse.y); // ending point
        context.stroke();
      }
    } // draw
  ...
  class Game {
    constructor(canvas) {
      ...
      this.canvas.addEventListener('mousedown', (e) => {
        // offsetX will give us horizontal coordinate
        // of the click on the target node
      ...
      this.canvas.addEventListener('mousemove', (e) => {
        // offsetX will give us horizontal coordinate
        // of the clickS on the target node
    ...
    init () {
      ...
      while (this.obstacles.length < this.numberOfObstacles && attempts < 500) {
        ...
        this.obstacles.forEach(obstacle => {
          ...
          const sumOfRadious = testObstacle.collisionRadius + obstacle.collisionRadius + distanceBuffer;
          if (distance < sumOfRadious) {
            overlap = true;
          }
        });
